...
IF(ODBC_CONFIG)
  ...
  MESSAGE(STATUS "${ODBC_CONFIG} ${ODBC_CONFIG_INCLUDES} output: ${result}")
  IF(result AND NOT ODBC_INCLUDE_DIR)
  ...
  MESSAGE(STATUS "${ODBC_CONFIG} ${ODBC_CONFIG_INCLUDES} output: ${ODBC_INCLUDE_DIR}, ${ODBC_CONFIG_LIBS} - ${ODBC_LIB_DIR}")
  IF(WITH_IODBC)
